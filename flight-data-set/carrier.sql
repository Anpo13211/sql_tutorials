-- This file contains the SQL commands to create and populate the airline.carrier table.
CREATE TABLE airline.carrier (
    code VARCHAR(8) NOT NULL DEFAULT '',
    description VARCHAR(80) DEFAULT NULL
);

INSERT INTO airline.carrier ( code, description )
VALUES
( '02Q', 'Titan Airways' ),
...
( 'K5', 'SeaPort Airlines Inc. d/b/a Wings of Alaska' ),
( 'K7', 'Arizona Express' ),
